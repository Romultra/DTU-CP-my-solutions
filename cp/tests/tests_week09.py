...
import unittest
from cp.ex09.vector import Vector, make_vector, print_vector, dot, scale, add, sub, hat, make_line_segment, point_on_line, LineSegment
...
class TestRectangleInception(UTestCase):
    def test_inception_areas(self):
        from cp.ex09.rectangle import make_a_rectangle, Rectangle, Point, rectangle_inception, area
...
class TestIntersection(UTestCase):
    def test_do_they_intersect(self):
        from cp.ex09.vector import make_vector, make_line_segment, do_they_intersect, intersect, print_vector
...
class GetAllIntersections(UTestCase):
    ...
    def test_get_intersections_one(self):
        # from cp.ex09.vector import make_vector, make_line_segment, make_square_with_position, get_intersections
